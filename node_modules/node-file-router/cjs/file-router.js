      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 14:
          ...
          return _context.abrupt("return", function requestHandler() {
            ...
            var method = getMethod && getMethod.apply(void 0, args);
            var matchedRoute = routeHandlers.find(function (_ref2) {
              var regex = _ref2.regex,
                routeMethod = _ref2.method;
              return regex.test(pathname) && (!routeMethod || method === routeMethod);
            });
            if (!matchedRoute) {
              return notFoundHandler.apply(void 0, args);
            }
            ...
            if ((0, _object.isRecordWith)(handler) && method && handler[method]) {
              return handler[method].apply(handler, args.concat([routeParams]));
            }
            if ((0, _object.isFunction)(handler)) {
              return handler.apply(void 0, args.concat([routeParams]));
            }
            return notFoundHandler.apply(void 0, args.concat([routeParams]));
          });
        case 16:
        case "end":
